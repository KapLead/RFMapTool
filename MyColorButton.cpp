...
#ifdef CMyColorButton
#undef CMyColorButton      CMyColorButton
#endif

// CMyColorButton
IMPLEMENT_DYNAMIC(CMyColorButton, CButton)
...
BOOL CMyColorButton::Attach(const UINT nID, CWnd* pParent, const COLORREF BGColor, const COLORREF FGColor, const COLORREF DisabledColor, const UINT nBevel)
{
...
void CMyColorButton::DrawFrame(CDC *DC, CRect R, int Inset)
{ 
...
void CMyColorButton::DrawLine(CDC *DC, CRect EndPoints, COLORREF color)
{ 
	CPen newPen;
...
void CMyColorButton::DrawLine(CDC *DC, long left, long top, long right, long bottom, COLORREF color)
{ 
	CPen newPen;
	newPen.CreatePen(PS_SOLID, 1, color);
	CPen *oldPen = DC->SelectObject(&newPen);
